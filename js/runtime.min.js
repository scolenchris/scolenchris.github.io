var now = new Date();
function createtime() {
  var t = new Date("08/11/2023 00:00:00");
  ...
  (g =
    r < 18 && r >= 9
      ? `<span class='textTip'> 本站勉强运行了 ${a} 天</span><span id='runtime'> ${r} 小时 ${i} 分 ${l} 秒 </span> <i class='fas fa-check-square' style='color:white'></i>`
      : `<span class='textTip'> 本站勉强运行了 ${a} 天</span><span id='runtime'> ${r} 小时 ${i} 分 ${l} 秒 </span> <i class='fas fa-check-square' style='color:white'></i>`),
